...
\renewcommand{\nomgroup}[1]{%
\ifthenelse{\equal{#1}{G}}{\item[\textbf{Garben und Funktionenräume}]}{%
\ifthenelse{\equal{#1}{A}}{\item[\textbf{Generelle Notation}]}{%
\ifthenelse{\equal{#1}{K}}{\item[\textbf{Kohologietheorie}]}{
