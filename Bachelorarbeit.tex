...
\begin{defi}[Seite]
Für zwei Simplizes $\sigma,\tau\in\mathbb{R}^n$ schreiben wir $\tau\leq\sigma$, falls die Ecken von $\tau$ auch Ecken von $\sigma$. Dann heißt $\tau$ \emph{Seite} von $\sigma$. Falls zusätzlich noch $\tau \neq \sigma$ gilt, schreiben wir $\tau <\sigma$ und nenen $\tau$ \emph{eigentliche Seite} von $\sigma.$
\end{defi}
